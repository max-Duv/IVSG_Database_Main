...
'''
    ...
    # 
    #       4. def update_df(self, df, is_sensor, table_name, mapping_dict, db_col_lst, bag_files_id)
...
class DFBuilder:
    ...
    '''
    def update_df(self, df, is_sensor, table_name, mapping_dict, db_col_lst, bag_files_id):
        try:
            if (is_sensor == 1):
...
'''
    ...
    #       4. If you're reading from CSV files, you need to know either the corresponding bag file name AND id.
...
def main():
    ...
    if (from_bag == 1):
        ...
        for bag_file in bag_files:
            ...
            # bag_csv_to_df(bag_file, from_bag, from_csv, topic_lst, to_csv)               # Create a data frame
