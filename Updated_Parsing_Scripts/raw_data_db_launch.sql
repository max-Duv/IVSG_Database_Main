...
Written by Sadie Duncan at IVSG during summer 2024
Supervised by Professor Sean Brennan

Purpose:
    This SQL script creates what will be the beginning of the raw data database. To simplify things, start
    by setting up the most important tables (encoder, GPS SparkFun sensors, 3D LiDAR (velodyne_lidar, ouster_lidar),
    and trigger). Other tables will be added later.
